...
**Result: OK** -- 48 passed, 0 violation(s)
...
- stability_trials.csv row count for CRISP-MAX (900) == n_trials_total (900)
- stability class_change_rate for CRISP-MAX reconciles with stability_trials.csv
- stability_trials.csv row count for PROPOSED-HFIS (900) == n_trials_total (900)
- stability class_change_rate for PROPOSED-HFIS reconciles with stability_trials.csv
- stability_trials.csv row count for WEIGHTED-MEAN (900) == n_trials_total (900)
- stability class_change_rate for WEIGHTED-MEAN reconciles with stability_trials.csv
- stability by_variable rows for CRISP-MAX sum to overall n_trials_total (900)
- stability by_original_class rows for CRISP-MAX sum to overall n_trials_total (900)
- stability by_variable rows for PROPOSED-HFIS sum to overall n_trials_total (900)
- stability by_original_class rows for PROPOSED-HFIS sum to overall n_trials_total (900)
- stability by_variable rows for WEIGHTED-MEAN sum to overall n_trials_total (900)
- stability by_original_class rows for WEIGHTED-MEAN sum to overall n_trials_total (900)
...
- publication_readiness.provisional_parameters_used matches run_summary.json's top-level provisional_parameters_used
- parameter_provenance.csv engaged PROVISIONAL rows match run_summary.json's provisional_parameters_used
