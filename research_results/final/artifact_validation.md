...
- n_timestamps_processed (13732) == persisted iaq_index_results count (13732)
- completeness_summary sums to n_timestamps_processed (13732)
- every FAILED row has a null index_value, null index_class, and no dominant_component
- index_timeseries.csv row count (13732) == persisted iaq_index_results count (13732)
