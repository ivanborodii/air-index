...
- **Metric**: `masking_rate` = `0.991`
- **Limitation**: 748/755 critical-component events were masked by WEIGHTED_MEAN this run.
...
- **Artifact**: `exports/index_timeseries.csv`
- **Metric**: `dominant_component_frequency` = `{'A': 1536, 'M': 2306, 'V': 175}`
...
- **Metric**: `class_change_rate (PROPOSED_HFIS vs CRISP_CLASS_MAX)` = `0.36777777777777776 vs 0.3811111111111111`
- **Limitation**: PROPOSED_HFIS class-change rate 0.368 < CRISP_CLASS_MAX's 0.381 under the same perturbation trials.
...
- **Metric**: `per_timestamp_latency_ms.mean, peak_memory_mb` = `1699.601126994027 ms`
- **Limitation**: Measured on Linux-6.12.62+rpt-rpi-2712-aarch64-with-glibc2.41: mean per-timestamp latency 1699.6 ms, peak memory 451.09375 MB.
