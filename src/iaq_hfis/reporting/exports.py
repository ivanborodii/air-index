...
COLUMNS: dict[str, list[ColumnSpec]] = {
    INDEX_TIMESERIES: [
        ...
        ColumnSpec("index_class", "str", "-", "Favourable | Acceptable | Degraded | Critical; null if FAILED."),
    ...
    COMPONENT_SCORES_TIMESERIES: [
        ...
        ColumnSpec("membership_favorable", "float", "0-1", "Degree of membership in Favourable."),
    ...
    CONTINUITY_GRID: [
        ...
        ColumnSpec("channel", "str", "-", "pm2_5 | pm10 | co2 | temperature | humidity."),
        ColumnSpec("context", "str", "-", "favourable | acceptable | degraded -- severity of the OTHER, non-swept channels for this sweep."),
