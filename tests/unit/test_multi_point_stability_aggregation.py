...
def test_aggregate_overall_counts_class_changes_and_index_change_stats():
    rows = [
        _row("PROPOSED_HFIS", "Favorable", False, 0.0, "s1"),
        _row("PROPOSED_HFIS", "Acceptable", True, 5.0, "s1"),
        _row("PROPOSED_HFIS", "Favorable", False, 1.0, "s2"),
    ]
...
def test_aggregate_moved_better_and_worse_use_class_severity():
    ...
    rows = [
        _row("PROPOSED_HFIS", "Favorable", True, 10.0, "s1", baseline_class="Acceptable"),   # better
...
def test_aggregate_by_variable_separates_boundary_channels():
    rows = [
        ...
        _row("FUZZY_COMPONENT_MAX", "Favorable", False, 0.0, "s2", boundary_channel="co2"),
    ]
...
def test_aggregate_by_original_class_groups_by_baseline_class():
    rows = [
        _row("WEIGHTED_MEAN", "Acceptable", True, 5.0, "s1", baseline_class="Favorable"),
...
def test_aggregate_by_point_is_one_row_per_sample_method():
    rows = [
        _row("PROPOSED_HFIS", "Favorable", False, 0.0, "s1"),
        _row("PROPOSED_HFIS", "Favorable", False, 0.0, "s2"),
        _row("FUZZY_COMPONENT_MAX", "Favorable", False, 0.0, "s1"),
    ]
...
def test_aggregate_is_deterministic_and_sorted():
    rows = [
        _row("WEIGHTED_MEAN", "Favorable", False, 0.0, "s1"),
        _row("FUZZY_COMPONENT_MAX", "Favorable", False, 0.0, "s1"),
        _row("PROPOSED_HFIS", "Favorable", False, 0.0, "s1"),
    ]
